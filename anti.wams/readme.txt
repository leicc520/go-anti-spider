使用golang编译的情况
GOARCH=wasm GOOS=js go build -ldflags "-w -s -X main.GPKey=xxx.xxx.xxx.xx" -o anti.wasm .
使用tinygo编译，
tinygo.exe build -no-debug -ldflags "-X 'main.GPKey=xxx.xxx.xxx.xx'" -target wasm -o anti.wasm .
